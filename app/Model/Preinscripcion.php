...
class Preinscripcion extends Model
{
    ...
    protected $fillable = [
        ...
        'tipo_nomina','universo_nominal','universo','numero_empleado','id_unidad_administrativa','unidad_administrativa','id_sector', 'sector', 'clave_dependencia','nivel_salarial', 'nivel_salarial', 'seccion_sindical', 'curp', 'hora_entrada',
