...
<center><h1>Pre-registro</h1></center>

<p><b>Favor de adjuntar los siguientes documentos:</b></p>
<ul>
<li>Acta de Nacimiento</li>
<li>Clave Única de Registro de Población (CURP) (lo puedes descargar desde la página <a href="https://www.gob.mx/curp" target="_blank"><font color="#000000">https://www.gob.mx/curp</font></a></li>
...
<div class="mt-2">
            ...
            <div class="row">
                ...
                <input type="file" id="filename_acta_nacimiento" name="filename_acta_nacimiento" accept="application/msword, application/pdf">
                </div>
                <div class="col">
                ...
                <h6>Comprobante de Domicilio</h6>
                    <input type="file" id="filename_comprobante_domicilio" name="filename_comprobante_domicilio" accept="application/msword, application/pdf">
                </div>
                <div class="col">
            ...
            <div class="row mt-2">
                ...
                <h6>Último recibo de nómina:</h6>
                    <input type="file" id="filename_recibo_nomina" name="filename_recibo_nomina" accept="application/msword, application/pdf">
                    </div>
...
<input type="file" id="filename_certificado_bachillerato" name="filename_certificado_bachillerato" accept="application/msword, application/pdf">
</div>    
...
<option id="derecho_economia" name="derecho_economia">Derecho con Acentuación en Economía</option>
...
<input type="file" id="filename_certificado_secundaria" name="filename_certificado_secundaria" accept="application/msword, application/pdf">
</div> 
...
<option id="adm_mercadotecnia" name="adm_mercadotecnia">Administración y Mercadotecnia</option>
<option id="edu_tecnologia" name="edu_tecnologia">Educación con Acentuación en Tecnología Educativa</option>
