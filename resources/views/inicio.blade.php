...
<div class="container-fluid">
    ...
    <div style="top: 5%; position: absolute; z-index: 50;">
        <div style="display: block; font-style: normal; color: #fff; font-size: 45pt; padding: 5px; font-weight: 500;"
            align="center">Programa de Educación a Distancia para las personas servidoras públicas del Gobierno de la
            Ciudad de México.</div>
        <div style="margin-top: 40px; display: block; color: #fff; font-size: 45pt; padding: 5px; font-weight: 500;"
            align="center">DGAP-EDUCAD</div>
    </div>
</div> --}}
...
<div class="row" style="margin-top 40px;">
    <div style="font-family: " Open Sans", sans-serif; font-size: 12pt; font-weight: 400; line-height: 1.56; font-style:
        inherit;">
                ...
                <div id="consiste" class="card border-light" style="margin-top: 40px; padding: 10px;">
                    ...
                    <div class="card-text">
                        ...
                        <p align="justify">Para cumplir con este propósito, el Gobierno de la Ciudad de México, a través
                            ...
                            niveles
                            Medio Superior y Superior (incluyendo Posgrado).</p>
                        <p align="justify">
